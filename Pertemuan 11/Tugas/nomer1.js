...
// Function Mahasiswa
function Mahasiswa(mhsNama, mhsNim, mhsBirth, mhsProdi, mhsNilai = null){
  var nama = mhsNama
  var birth = mhsBirth
  var nim = mhsNim      
  var prodi = mhsProdi
  ...
  // Function get untuk mendapatkan output data mahasiswa
...
do{
  ...
  for(let i = 0; i < array.length; i++){
    if(array[i].getNim() == nim) {
      array[i].setNilai(nilai)
    }
  }
